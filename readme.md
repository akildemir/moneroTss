...
>
> https://gitlab.com/akil27/moneroTss
...
* Create an issue or find an existing issue on https://gitlab.com/akil27/moneroTss/-/issues
...
if the merge request upgrade the [version](https://gitlab.com/akil27/moneroTss/-/blob/master/version), then a new release will be created automatically, and the repository will be tagged with
