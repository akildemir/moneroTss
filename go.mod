...
require (
	github.com/akildemir/go-tss v0.0.0-20211214111608-4a9e15716350
	...
	github.com/haven-protocol-org/go-haven-rpc-client v0.0.0-20220125170735-6825bb255008 // indirect
